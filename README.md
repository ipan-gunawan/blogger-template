...
## Usage
To use this code, you just go to the [index.xhtml](./index.xhtml) file and copy the code then paste it in <a href="https://www.blogger.com/" target="blank">Blogger</a> template editor.
